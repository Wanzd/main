package com.pd.it.system.cache;
...
public class MybatisRedisCache implements Cache {
	...
	private RedisTemplate<Serializable, Serializable> redisTemplate = (RedisTemplate<Serializable, Serializable>) SpringUtil
			.getContext().getBean("redisTemplate");
