...
(function($) {
	...
	function _e(_f, _10) {
		...
		if (_12.multiline) {
			...
			_14.css({
						paddingTop : _18 + "px",
						paddingBottom : _18 + "px"
					});
		}
		_14._outerWidth(tb.width() - _16.length * _12.iconWidth
				- btn._outerWidth());
		tb.insertAfter(_f);
		_12.onResize.call(_f, _12.width, _12.height);
		function _17(_19) {
			return (_12.iconAlign == _19 ? _15._outerWidth() : 0)
					+ (_12.buttonAlign == _19 ? btn._outerWidth() : 0);
		};
	};
	function _1a(_1b) {
	...
	function _1f(_20) {
		...
		if (!_22.disabled && !_22.readonly) {
			...
			for (var _24 in _22.inputEvents) {
				_23.bind(_24 + ".textbox", {
							target : _20
						}, _22.inputEvents[_24]);
			}
		}
		var _25 = tb.find(".textbox-addon");
		_25.unbind().bind("click", {
					target : _20
				}, function(e) {
					var _26 = $(e.target)
	...
	$.fn.textbox.methods = {
		...
		getTipX : function(jq) {
			...
			if (_4d.tipPosition == "right") {
				return (_4d.iconAlign == "right" ? _4f : 0)
						+ (_4d.buttonAlign == "right" ? _50 : 0) + 1;
			} else {
				if (_4d.tipPosition == "left") {
					return (_4d.iconAlign == "left" ? -_4f : 0)
							+ (_4d.buttonAlign == "left" ? -_50 : 0) - 1;
				} else {
	...
	$.fn.textbox.parseOptions = function(_51) {
		var t = $(_51);
		return $.extend({}, $.fn.validatebox.parseOptions(_51), $.parser
						.parseOptions(_51, ["prompt", "iconCls", "iconAlign",
